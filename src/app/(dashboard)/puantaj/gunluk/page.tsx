...
export default function GunlukPuantajPage() {
  ...
  const [filterCompanyType, setFilterCompanyType] = useState("all"); // all | MAIN | SUBCONTRACTOR
  ...
  }, [date, filterTeam, filterCompany, filterCompanyType, filterProject]);
  ...
  const exportExcel = () => {
    ...
    XLSX.writeFile(wb, `puantaj-gunluk-${date}.xlsx`);
  };
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-bold">Günlük Puantaj</h1>
      ...
      {loading ? (
        ...
        <Card>
          <CardContent className="p-12 text-center text-muted-foreground">
            ...
            <p className="text-sm">Seçili proje ve filtrelere uygun çalışan yok. Çalışan eklemek için Çalışanlar sayfasını kullanın.</p>
          </CardContent>
        </Card>
      ) : (
        <>
