...
/* ═══════════════════════════════════════════════════════════ */
export default function ProjectPuantajPage() {
    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-1">
          Projeye atanmış çalışanların günlük devam takibi
        </p>
      </div>
...
/* ═══════════════════════════════════════════════════════════
   GÜNLÜK PUANTAJ (projeye atanmış çalışanlar için)
   ═══════════════════════════════════════════════════════════ */
                  ...
                  <Fragment key={group.company.id}>
                    ...
                    <TableRow className="bg-muted/50">
                      <TableCell colSpan={6} className="py-2 font-semibold text-sm">
                        {group.company.type === "MAIN" ? "🏢" : "🛠️"} {group.company.name}
